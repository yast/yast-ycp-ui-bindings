...
module Yast
  class DefaultButtons2Client < Client
    def main
      Yast.import "UI"
      ...
      @help_text = "<p>This is a help text.</p>" +
        ...
        "<p>Help texts may contain the product name (&product;) with a macro that will " +
        "automatically be expanded - multiple times (&product;) if needed.</p>"
      ...
      while true
        ...
        Builtins.y2milestone("Doing something") if @button == :doit1
      end
...
Yast::DefaultButtons2Client.new.main
